            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="rename-wishlist-modal-input">
                        <form>
                            <label>Name</label>
                            <input type="text" name="field-rename-wishlist" required>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="share" id="btn-rename-wishlist">Save</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-content-delet text-center">
                        <p>Are you sure you want to delete this wishlist category?</p>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="share" id="btn-delete-wishlist">Save</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="share" id="btn-add-wishlist">Save</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
<div class="modal-01 filter-modal invite-others">
    <div class="modal fade" id="shareProperty" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Share this property</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <!--<button type="button" class="share" data-bs-toggle="modal" data-bs-target="#staticBackdrop5"><i class="fa fa-angle-left" aria-hidden="true"></i></button>-->
                </div>
                <div class="modal-body">
                    ...
                    <div class="shares-to-other-li">
                        ...
                        <div class="link-box">
                            <a href="#">
                                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#a)"><path d="M27.027 0H6.973A6.98 6.98 0 0 0 0 6.973v20.054A6.98 6.98 0 0 0 6.973 34h20.054A6.98 6.98 0 0 0 34 27.027V6.973A6.98 6.98 0 0 0 27.027 0M17 25.633c-1.237 0-2.428-.165-3.542-.467l-4.028 2.06.596-3.58c-2.628-1.701-4.315-4.343-4.315-7.31C5.71 11.2 10.765 7.039 17 7.039s11.29 4.162 11.29 9.297-5.055 9.297-11.29 9.297" fill="url(#b)"/></g><defs><linearGradient id="b" x1="17" y1="0" x2="17" y2="34" gradientUnits="userSpaceOnUse"><stop stop-color="#5BF675"/><stop stop-color="#0CBD2A"/></linearGradient><clipPath id="a"><path fill="#fff" d="M0 0h34v34H0z"/></clipPath></defs></svg>
                        ...
                        <div class="link-box">
                            <a href="#">
                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#a)" fill-rule="evenodd" clip-rule="evenodd"><path d="M17 0C7.423 0 0 7.015 0 16.49c0 4.956 2.031 9.239 5.339 12.197.278.248.445.597.457.97l.092 3.023a1.36 1.36 0 0 0 1.909 1.203l3.374-1.49c.286-.126.607-.15.908-.067 1.55.427 3.2.654 4.92.654 9.578 0 17-7.015 17-16.49S26.578 0 17 0" fill="url(#b)"/><path d="m6.791 21.313 4.994-7.922a2.55 2.55 0 0 1 3.687-.68l3.972 2.978a1.02 1.02 0 0 0 1.229-.003l5.364-4.071c.716-.544 1.65.313 1.171 1.073l-4.993 7.923a2.55 2.55 0 0 1-3.688.68l-3.972-2.979a1.02 1.02 0 0 0-1.228.004l-5.364 4.071c-.716.543-1.65-.313-1.172-1.074" fill="#fff"/></g><defs><radialGradient id="b" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(6.548 33.587)scale(37.0281)"><stop stop-color="#09F"/><stop offset=".61" stop-color="#A033FF"/><stop offset=".935" stop-color="#FF5280"/><stop offset="1" stop-color="#FF7061"/></radialGradient><clipPath id="a"><path fill="#fff" d="M0 0h34v34H0z"/></clipPath></defs></svg>
                    ...
                    <div class="terms-and-other-pages-link">
                        <div class="img-box">
                            ...
                            <div class="content-box">
                                <span>Share this link with any of the above socials</span>
                            </div>
                        </div>
                    </div>
                </div>
