...
/* Template Name: Article Alternative Template */
get_header();
?>
...
<section class="blog-sec-01 main-post-imgbox main-post-imgbox-white alertnative-article-sec-01 " style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/alertnative-article-bg.jpg);">
    ...
    <div class="row">
            ...
            <div class="img-box" style="width: 100%; display: inline-block;">
                    ...
                    <div class="text">
                        <h5> <a href="#" tabindex="0">Enjoy your own private pool, by the hour</a> </h5>
                        <p>Whether you're planning an event or just looking for a poolside getaway, Lucky Backyards is here to help you make a splash</p>
                        <div class="icon">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <ul>
                    <li> <a href="#article-01">MARIE-ANTOINETTE</a> </li>
                    <li> <a href="#article-02">BAZAR LABRIN</a> </li>
                    <li> <a href="#article-03">STREET FOOD IN VICTORIA</a> </li>
                    <li> <a href="#article-04">LE JARDIN DE<br> SEYCHELLOIS</a> </li>
                    <li> <a href="#article-05">CATCH OF THE DAY</a> </li>
                </ul>
            </div>
            <div class="col-lg-9 col-md-9">
                ...
                <div class="text-box">
                        <div class="text">
                            <p>“Some of our most enthusiastic hosts are so dedicated to their guests having an exceptional stay that they’re challenged to find their own time and resources for themselves,” says Elle. “They’re givers and sometimes givers swing too far into that giving activity.</p>
                            <p>The saying “You have to taste a culture to understand it” certainly holds very true for the Seychelles. Food in the Seychelles is a melting pot of cultural influences that have been blended with the islands’ natural bounty of fruits, spices and ocean-fresh seafood. Here are our top picks of places to experience authentic Creole cuisine:</p>
                            
                        </div>
                    </div>
                    <div class="text-box" id="article-01">
                        <div class="text" >
                            <h3>MARIE-ANTOINETTE</h3>
                            <p>This Seychelles restaurant is housed in a hundred-year-old colonial-style building in the heart of Victoria. As the Seychelles’ oldest restaurant, this establishment serves up delicious food prepared according to traditional Creole recipes. In fact, the menu has not changed much since the restaurant first opened in 1972, and you can still enjoy Creole specialities such as battered parrot fish, octopus curry and Chauve Souris Frugivore (curried fruit bat).</p>
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/STREET-FOOD-IN-VICTORIA.png" alt="">
                            <div class="timing-other-thing">
...
<p>Monday to Saturday: 12:00-14:30 (Lunch) | 18:30-21:00 (Dinner)</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-box" id="article-02">
                        <div class="text" >
                            <h3>BAZAR LABRIN</h3>
                            <p>Every Wednesday night, the Seychelles’ most popular beach, Beau Vallon, is transformed into a vibrant market with colourful stalls appearing at the side of the road, selling popular Seychelles street food at traditional prices. Fresh fruit juices, handmade souvenirs and local artwork are also on sale, lending a kaleidoscopic ambience to the evening. As the sun sinks below the horizon, twinkling bonfires light up on the beach for the Seychelles’ traditional moutay dance.</p>
                            <div class="timing-other-thing">
                                <p><svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.9731 14.5269L14.0269 13.4731L10.25 9.6959V4.99998H8.75V10.3038L12.9731 14.5269ZM9.50165 19.5C8.18772 19.5 6.95268 19.2506 5.79655 18.752C4.6404 18.2533 3.63472 17.5765 2.7795 16.7217C1.92427 15.8669 1.24721 14.8616 0.748325 13.706C0.249442 12.5504 0 11.3156 0 10.0017C0 8.68772 0.249333 7.45268 0.748 6.29655C1.24667 5.1404 1.92342 4.13472 2.77825 3.2795C3.6331 2.42427 4.63834 1.74721 5.79398 1.24833C6.94959 0.749443 8.18437 0.5 9.4983 0.5C10.8122 0.5 12.0473 0.749334 13.2034 1.248C14.3596 1.74667 15.3652 2.42342 16.2205 3.27825C17.0757 4.1331 17.7527 5.13834 18.2516 6.29398C18.7505 7.44959 19 8.68437 19 9.9983C19 11.3122 18.7506 12.5473 18.252 13.7034C17.7533 14.8596 17.0765 15.8652 16.2217 16.7205C15.3669 17.5757 14.3616 18.2527 13.206 18.7516C12.0504 19.2505 10.8156 19.5 9.50165 19.5ZM9.49998 18C11.7166 18 13.6041 17.2208 15.1625 15.6625C16.7208 14.1041 17.5 12.2166 17.5 9.99998C17.5 7.78331 16.7208 5.89581 15.1625 4.33748C13.6041 2.77914 11.7166 1.99998 9.49998 1.99998C7.28331 1.99998 5.39581 2.77914 3.83748 4.33748C2.27914 5.89581 1.49998 7.78331 1.49998 9.99998C1.49998 12.2166 2.27914 14.1041 3.83748 15.6625C5.39581 17.2208 7.28331 18 9.49998 18Z" fill="#484848"></path>
</svg>Opening hours:</p>
<p>Wednesdays: 16:30-21:00</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-box" id="article-03">
                        <div class="text" >
                            <h3>STREET FOOD IN VICTORIA</h3>
                            <p>The narrow streets of Victoria are lined with tiny shops and food stalls, each offering a unique insight into the culinary culture of the Seychelles. Take a stroll through the bustling capital and make sure to sample local Creole cuisine while searching for souvenirs and admiring the local architecture. Not to be missed is Callino’z, serving classical street bites from Jardin de Enfants, opposite the Convention Centre.</p>
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/MARIE-ANTOINETTE.png" alt="">
                            <p style="color: black; font-size:14px;padding-right: 30px; ">How to get there: A taxi from the hotel costs roughly EUR 50* or, for an authentically local experience, take the public bus. There is a bus stop on the West Coast Road, just 10 minutes from the hotel’s main gate. A ticket costs EUR 0.30*.</p>
                        </div>
                    </div>
                    <div class="text-box" id="article-04">
                        <div class="text" >
                            <h3>LE JARDIN DE SEYCHELLOIS</h3>
                            <p>Of course, it is possible to enjoy traditional Creole cuisine without ever having to leave the resort. Every fifth night, the buffet dinners at Café Lazare are transformed into a celebration of local cuisine with our weekly Creole extravaganza. Simmering curries, grilled fish and piles of fresh fruits are just some of the local favourites that we invite you to sample.</p>
                        </div>
                    </div>
                    <div class="text-box" id="article-05">
                        <div class="text" >
                            <h3>CATCH OF THE DAY</h3>
                            <p>The Seychelles is home to some of the richest fishing grounds in the world, where angling has become a way of life. It’s no surprise, then, that grilled fish is a staple of Creole cuisine. There is no better way to enjoy this simple, yet delicious dish than if you’ve caught the fish yourself. Bring back the day’s catch from your latest fishing expedition and our chefs will gladly prepare it for you.</p>
                        </div>
                    </div>
...
<section class="article-sec-02 blog-sec-05 main-post-imgbox">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="img-box">
        <a href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/be-a-host-img-01.png" alt=""></a>
        <ul>
            <li><a href="javascript:void(0)"> Learning </a></li>
            <li><a href="javascript:void(0)"> Host </a></li>
        </ul>
        <div class="text">
            <h5> <a href="#">Unlock Your Property's<br> Potential: Become a Host</a> </h5>
            <p>Moreover, many of these outdoor spaces come equipped with amenities that make planning...</p>
            <div class="icon">
                <p><i class="fa fa-clock-o" aria-hidden="true"></i> 4 min</p>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-4">
            <div class="img-box">
        <a href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/be-a-host-img-02.png" alt=""></a>
        <ul>
            <li><a href="javascript:void(0)"> Learning </a></li>
            <li><a href="javascript:void(0)"> Host </a></li>
        </ul>
        <div class="text">
            <h5> <a href="#">Welcome Guests – Welcome Income</a> </h5>
            <p>Moreover, many of these outdoor spaces come equipped with amenities that make planning...</p>
            <div class="icon">
                <p><i class="fa fa-clock-o" aria-hidden="true"></i> 4 min</p>
            </div>
            ...
            <div class="col-lg-4 col-md-4">
            <div class="img-box">
        <a href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/be-a-host-img-03.png" alt=""></a>
        <ul>
            <li><a href="javascript:void(0)"> Learning </a></li>
            <li><a href="javascript:void(0)"> Host </a></li>
        </ul>
        <div class="text">
            <h5> <a href="#">Open Your Doors to New<br> Opportunity</a> </h5>
            <p>Moreover, many of these outdoor spaces come equipped with amenities that make planning...</p>
            <div class="icon">
                <p><i class="fa fa-clock-o" aria-hidden="true"></i> 4 min</p>
            </div>
