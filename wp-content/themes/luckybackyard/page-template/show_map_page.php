...
/* Template Name: Show Map Page Template */
get_header();
?>

<style>
    .show-on-map.show-list {
    z-index: 9999999999999999999;
}
</style>

<div class="show-map-iframe">
<iframe src="<?php echo get_field('map')?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
