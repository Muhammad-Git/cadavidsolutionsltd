...
<section class="property-page-sec-02">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="text">
                    <h3>Amazing Private Pool + Alpaca Experience</h3>
                </div>
                <div class="amazing-main-box">
                    <div class="box-01">
                        <ul>
                            ...
                            <li><a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-icon-03.png" alt=""> Spain, Barcelona</a></li>
                            <li><a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-icon-04.png" alt=""> Up to 8 guests allowed</a></li>
                            <li><a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-icon-05.png" alt=""> 4 Bedrooms (8 bed)</a></li>
                            <li><a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-icon-06.png" alt=""> 6 Bathrooms</a></li>
                        </ul>
                    </div>
                    <div class="box-02">
                        <ul>
                            <li><a href="javascript:void(0)"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-icon-07.png" alt=""> Add to Favorites</a></li>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-01.png" alt="Image Gallery">
                    <div class="virtual-box">
                        ...
                        <a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-01.png" data-fancybox="gallery" data-caption="Caption Images 1">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-gallery.png" alt="">49+
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-12">
                <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-02.png" alt="Image Gallery">
                    <div class="virtual-box">
                        <a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/virtual-tour.png" alt=""> Virtual Tour </a>
                        <a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-02.png" data-fancybox="gallery" data-caption="Caption Images 1">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-gallery.png" alt="">49+
                        </a>
                    </div>
                </div>
                <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-03.png" alt="Image Gallery">
                    <div class="virtual-box">
                        <a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/virtual-tour.png" alt=""> Virtual Tour </a>
                        <a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-03.png" data-fancybox="gallery" data-caption="Caption Images 1">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-gallery.png" alt="">49+
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-12">
                <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-04.png" alt="Image Gallery">
                    <div class="virtual-box">
                        <a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/virtual-tour.png" alt=""> Virtual Tour </a>
                        <a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-04.png" data-fancybox="gallery" data-caption="Caption Images 1">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-gallery.png" alt="">49+
                        </a>
                    </div>
                </div>
                <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-05.png" alt="Image Gallery">
                    <div class="virtual-box">
                        <a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/virtual-tour.png" alt=""> Virtual Tour </a>
                        <a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/amazing-img-05.png" data-fancybox="gallery" data-caption="Caption Images 1">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-gallery.png" alt="">49+
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="main-box-border">
                    <div class="circle-icon-boxes">
                        <ul>
                            <li> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-icon-01.png" alt=""> Up to 8 guests allowed</li>
                ...
                <div class="main-box-border" id="in-page-link-02">
                    <div class="text-box-content-01 heading">
                        ...
                        <p>This pool is great getaway for any occasion. The pool is HEATED YEAR ROUND. 90 degrees in Fall and winter. If you have dog coming,please add the dog swimmer amenity. If it is a holiday, please add the Holiday amenity. The pool has a beautiful waterfall, and large shallow area for kids. Plenty of pool floats, lounge chairs, a table with umbrella & 6 chairs. There is a separate lounge area under a pergola with couch and chairs, flatscreen tv, mini fridge and Bluetooth speaker. Sectional couch around the built in gas fire pit, bar with barstools. A separate couch and chair seating area near BBQ. <b>Hot tub is available with advance request, please add the hot tub amenity, there is a $30 charge to heat the hot tub.</b> Bathroom is available inside house located right off of pool, text me for entrance. Charcuterie boards available for order in Premium Amenities. <b>Please order 2 days in advance.</b></p>
                    </div>
                </div>
                ...
                <div class="main-box-border">
                    ...
                    <div class="read-all-btn-with-arrow">
                        <a href="#">Show all 24 Amenities </a>
                    </div>
                </div>
                            ...
                            <div class="ui calendar">
                                ...
                                <div class="ui input left icon">
                                    ...
                                    <select name="cars" id="cars">
                                        <option value="Guests 3, Pets 1">Guests 3, Pets 1</option>
                                        <option value="Guests 3, Pets 2">Guests 3, Pets 2</option>
                                        <option value="Guests 3, Pets 2">Guests 3, Pets 3</option>
                                        <option value="Guests 3, Pets 4">Guests 3, Pets 4</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading address-content" id="in-page-link-08">
                    <h4>Address</h4>
                    <ul>
                        <li><b>Address:</b> Epar.Od. Firon-Ormou Perissis</li>
                        <li><b>Area:</b> Paphos Town</li>
                        <li><b>Country:</b> Spain </li>
                        <li><b>City:</b> Barcelona</li>
                        <li><b>Zip:</b> 94117</li>
                    </ul>
                </div>
                        ...
                        <div class="main-icon-img-box">
                            ...
                            <div class="content-box">
                                <div class="title-content">
                                    ...
                                    <p> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/one-star.png" alt=""> 4,5</p>
                                </div>
